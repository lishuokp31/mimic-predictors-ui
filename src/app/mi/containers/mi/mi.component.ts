...
import { mapping } from './../../mapping-mi';
...
export class MiComponent {
  ...
  constructor(
    ...
    for (let i = 6; i < this.features_num && i <= 41; i++) {
    ...
    console.log(this.threshold_mapping_array)
    console.log(this.threshold_mapping_array_index1)
    console.log(this.threshold_mapping_array_index2)
    console.log(this.threshold_mapping_array_index3)

    this.id$ = this.store.select(MiState.id);
  ...
  handleAll(): void {
    for (var i = 0; i < this.threshold_mapping_array.length; i++) {
      if (
        this.threshold_mapping_array[i][0] != 145 &&
        this.threshold_mapping_array[i][0] != 146 &&
        this.threshold_mapping_array[i][0] != 144 &&
